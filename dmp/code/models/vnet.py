...
class VNet(nn.Module):
    def __init__(self, n_channels=3, n_classes=2, n_filters=16, normalization='none', has_dropout=False,return_layers = False):
    ...
    def decoder(self, features):
        ...
        if self.return_layers:
            return out, [globals()[f'x{j}'] for j in range(1, 10)]
        return out
